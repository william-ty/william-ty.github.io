class StretchEffect extends EffectShell {
  ...
  init() {
    ...
    this.geometry = new THREE.CircleGeometry( 0.6, 60 );
    // this.geometry = new THREE.SphereGeometry( 1, 32, 32 );

    // ? HOVER TITLE PLANE SIZE
    // thsdocument.querySelector(".name-title").style.backgroundColor = blue
    ...
    this.titleName = document.querySelector(".name-title")
    // this.titleName.addEventListener("mouseenter", (e)=> {
    //   this.geometry
    // })
  }
